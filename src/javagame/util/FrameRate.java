...
//All the utility code developed in this book goes into the utility package,which you can later turn into a utility library.
//The class is used to measure the frames per seconds (FPS) of the applications developed in this book.
//The FPS is stored as string in the format "FPS 100".This value is calculated every second.
